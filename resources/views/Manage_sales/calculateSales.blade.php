...
<!--Create table -->
        ...
        <body>
            <form action="/calcu/create" method="post">
                ...
                <table id="calcu">
                    ...
                    <tr>
                        ...
                        <td><input type="button" value="=" onclick="solve(); enableConfirmButton();"> </td>
                ...
                <br>
                <div>
                    <p style="text-align:center;">Press '=' before Confirm!</p>
                </div>
                <div class="center-button">
                    <button type="submit" class="btn btn-primary" id="confirmButton" data-target="#staticBackdrop" disabled>
                        Confirm
                    </button>
                </div>
                {{-- <p id="confirm"></p> --}}
            ...
            <script>
                ...
                // Function that enables the Confirm button

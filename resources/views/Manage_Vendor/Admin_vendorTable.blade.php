    ...
    <div class="container">
        ...
        <div class="row">
            <table class="table">
                ...
                <tbody>
                    @php
                        $totalProduct = 0; // Initialize the total product variable
                    @endphp
                    ...
                    @foreach($vendor_data as $data_vendor)
                        <tr>
                            ...
                            <td><a href="vendor/{{ $data_vendor->id }}/edit">Edit</a> &nbsp; <a href="vendor/{{ $data_vendor->id }}/delete/page">Delete</a></td>
                        </tr>

                        @php
                            // Update the total product
                            $totalProduct += $data_vendor->product;
                        @endphp
                    @endforeach
                </tbody>
            </table>
            ...
            <div>
                <strong>Total Product:</strong> {{ $totalProduct }}
            </div>
        </div>
    </div>
    </div>
